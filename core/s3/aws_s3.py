"""This module is responsible for the aws s3 functionality."""
...
class S3Manager:
    ...
    # def create_s3_path(self, path: str, key: str, replace_value: str):
    #     """Create the new path for the s3 with dynamic parameters"""
    #     try:
    #         # Replace the dynamic parameter in the key with the provided value
    #         s3_path = path.replace(f"{{{key}}}", str(replace_value))
    #         return s3_path
