...
class ErrorMessage:
    ...
    emailDeletedRecently = "This email is linked to a recently deleted account. You can register again after {days} day(s)."
    mobileDeletedRecently = "This mobile number is linked to a recently deleted account. You can register again after {days} day(s)."
